...
urlpatterns = [
    ...
    path('update_jobs_redirect/<int:job_id>', views.update_job_session_generataor, name='update_jobs_redirect'),
    ...
    path('candidates_list_test/', views.Candidates_list_test, name='candidates_list_test'),
